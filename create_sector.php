...
$stmt_insert = $conn->prepare("
    INSERT INTO sectors  (sector_code, half_hour_rate, location_point_a_lat, location_point_a_lon, location_point_b_lat, location_point_b_lon)
    VALUES (?,?,?,?,?,?)
");
$stmt_insert->bind_param("sddddd", $sector_code, $half_hour_rate, $location_point_a_lat, $location_point_a_lon, $location_point_b_lat, $location_point_b_lon);
